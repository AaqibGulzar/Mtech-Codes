...
library(mapview)
sf_ARW<- st_read(
  "c:/Users/ASUS/Desktop/R Programming/Shape file/american water/American_River_Watershed.shp"
)

elevation_ARW <- elevatr::get_elev_raster(locations = sf_ARW, z = 9, clip = "locations")
